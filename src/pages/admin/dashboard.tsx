            ...
            if(feed[x]?.title == options.series[check]?.name) {
              ...
              for(
                ...
                if(feed[mockStructure]?.title == feed[x]?.title){
                  init_structuredOne[feed[mockStructure]?.id] = feed[mockStructure].id
                } 
              }
            ...
            if(ifExist == 0){
              for(
                ...
                if(feed[mockStructureCount]?.title == feed[x]?.title){
                  init_structuredOne[mockStructureCount] = feed[mockStructureCount]?.id
                }
              }
              setOptions({ series : [{ data: init_structuredOne }]})
            }
      ...
      {loading ? (
        ...
        <Container maxWidth="xl">
          ...
          <UncontrolledCard style={{ margin: "10px" }}>
            <UncontrolledCard>
              <Typography variant='overline'>Branches Selection</Typography> <br />
              <FormControl>
