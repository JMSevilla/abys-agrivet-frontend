...
import {
    ...
    ControlledBackdrop,
    UncontrolledCard,
    ControlledCheckbox, NormalButton
} from '@/components'
...
import { customerSchema, customerBaseschema } from '@/utils/schema/Account/CustomerRegistrationSchema'
...
const options = {
  ...
  const CustomerAccountForm = () => {
    const {
        control, watch, trigger, resetField, getValues, setError
  ...
  export const CustomerAccountFormAdditional = () => {
    const [customerDetails, setCustomerDetails] = useAtom(CustomerAccountCreationAtom)
    const [open, setOpen] = useState(false)
    const { handleOnToast } = useToastContext()
    const customerAccountCreationRequest = useApiCallBack(async (api, args:AccountSetup) => {
    ...
    return (
        <FormProvider {...form}>
            <UncontrolledCard>
                <Typography variant='overline'>Customer Account Registration</Typography>
                <hr />
                <CustomerAccountForm />
                <NormalButton 
                sx={{
