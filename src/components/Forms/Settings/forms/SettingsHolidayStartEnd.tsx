...
import { BaseHolidayStartEndSchema, HolidayStartEndType } from "@/utils/schema/Appointment/HolidaySchema";
import { Chip, Grid, Typography } from "@mui/material";
import { FormProvider, useForm, useFormContext } from "react-hook-form";
import { DateRangePicker } from 'react-date-range'
import { useAtom } from "jotai";
import { HolidayPickAtom, HolidayStartEndAtom, HolidayTitleAtom } from "@/utils/hooks/useAtomic";
...
const SettingsHolidayStartEndForm = () => {
    const {
        setValue
    } = useFormContext<HolidayStartEndType>()
...
export const SettingsHolidayStartEnd = () => {
    ...
    const postnewholiday = useApiCallBack(async (api, args: CreateNewScheduleProps) => await api.abys.postNewHoliday(args))
