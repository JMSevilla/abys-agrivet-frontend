...
import { LoginType, baseLoginSchema } from "@/utils/schema/Account/AdminRegistrationSchema";
...
const LoginForm: React.FC<PropsWithChildren<{}> & { handleContinue: () => void }> = ({ children, handleContinue }) => {
    const {
        ...
        <div className="w-full max-w-md space-y-8">
          <div>
            ...
            <p className="mt-2 text-center text-sm text-gray-600">
              ...
              <a
                href={
                  platformStorage == 'customer' ? '/customer-registration' : '//'
                }
          ...
          <div className="mt-8 space-y-6">
            ...
            <div className="-space-y-px rounded-md shadow-sm">
              ...
              <div style={{
                ...
                label="Select Branch"
                onKeyPress={
                  platformStorage != 'customer' ? enterKeyTrigger : () => console.log("key press")
                }
                />
              </div>
            </div>
...
export const LoginAdditionalForm = () => {
    ...
    const loginRequest = useApiCallBack(async (api, args: AccountLoginWithJWT) => await api.authentication.Login(args))
