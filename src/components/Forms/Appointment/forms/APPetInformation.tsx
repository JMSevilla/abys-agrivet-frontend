...
const PetInformationForm = () => {
  const { control, setValue, watch, trigger, resetField } =
  ...
  return (
    <>
      <UncontrolledCard>
        <Typography variant="overline">Pet Information</Typography>
        <br />
        <Typography variant="caption">
          You can add your pets information here.
        </Typography>
        <hr />
        <NormalButton
...
export const PetInformation = () => {
  const [petsInformation, setPetsInformation] = useAtom(
