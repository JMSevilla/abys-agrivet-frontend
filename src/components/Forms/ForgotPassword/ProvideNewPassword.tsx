...
import {
  FPNewPasswordBaseSchema,
  FPNewPasswordType,
} from "@/utils/schema/Account/ForgotPasswordSchema";
...
const FPNewPasswordForm = () => {
  const { control, getValues, watch } = useFormContext<FPNewPasswordType>();
...
export const FPNewPassword = () => {
  ...
  const change_password = useApiCallBack(
    async (
      api,
      args: {
  ...
  return (
    <FormProvider {...form}>
      <Typography variant="button">
        Forgot Password | New Credentials
      </Typography>
      <br />
