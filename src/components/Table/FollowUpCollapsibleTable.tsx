...
const Row = (props: {
  ...
  const parsedPetInformation: PetInformationType[] = JSON.parse(
    row.petInformation
  );
          ...
          >
            <Box sx={{ margin: 1 }}>
              ...
              <ControlledGrid>
                <Grid item xs={6}>
                  <UncontrolledCard>
                    ...
                    {parsedPetInformation?.length > 0 &&
                      parsedPetInformation.map((item, index) => (
                        <>
                          <ControlledGrid>
                            <Grid item xs={6}>
                              <Typography
                ...
                <Grid item xs={6}>
                  <UncontrolledCard>
                    <Typography variant="button">Follow-up services</Typography>{" "}
                    <br />
                    <Typography variant="caption">Services:</Typography> <br />
              ...
              <ControlledGrid>
                <Grid item xs={6}>
                  <UncontrolledCard>
                    <Typography variant="button">Diagnosis</Typography>
                    <div
                      dangerouslySetInnerHTML={{
                        __html: JSON.parse(row.diagnosis),
                      }}
                    ></div>
                  </UncontrolledCard>
                </Grid>
                <Grid item xs={6}>
                  <UncontrolledCard>
                    ...
                    <div
                      dangerouslySetInnerHTML={{
                        __html: JSON.parse(row.treatment),
                      }}
                    ></div>
                  </UncontrolledCard>
                </Grid>
...
export const FollowUpCollapsibleTable: React.FC<CollapsibleTableProps> = (
  props
) => {
  const {
    data,
